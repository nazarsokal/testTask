...
from keyboards.general import clear_keyboard, main_keyboard, help_keyboard
...
async def help_message(message: Message):
    ...
    await bot.send_message(message.chat.id,"Корисні посилання:", reply_markup = help_keyboard())
